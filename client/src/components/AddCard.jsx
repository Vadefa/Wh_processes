...
const AddCard = observer(() => {
    ...
    const addGoods = async () => {
        ...
        try {
            ...
            let response = await createGood(goodData)
            console.log(response)
            if (response != '')
            alert("Товары успешно добавлены." + response)
            else
    ...
    return (
        <div className={classes.wrapper}>
            <div className={classes.card}>
                <div className={classes.title}>Добавить товар</div>
                {
                    inputList.map(input =>
                ...
                <div className={classes.buttons}>
                    ...
                    <Button className={classes.sendButton} onClick={addGoods} disabled={disabled}>Отправить</Button>
                </div>
            </div>
        </div>
    );
